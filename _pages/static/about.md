...
مطالب در شاخه‌ی pages/dynamic_ قرار دارند و از فرمت Markdown استفاده می‌کنند و برای راحتی در ویرایش متون با این فرمت می‌توانید از ویرایشگر صفحات در گیت‌هاب یا [http://linuxihaa.ir/ckeditor](http://linuxihaa.ir/ckeditor) استفاده کنید و بعد از ویرایش متن، دکمه‌ی Markdown را زده و خروجی را دریافت کنید.

نام هر فایل در شاخه pages/dynamic_ مسیر URL مطلب شما در سایت خواهد بود.
...
* featured که تصویر شاخص مطلب است و می‌توانید بعد از قرار دادن تصویر در شاخه‌ی public/images نام فایل آن را در این قسمت بنویسید.
...
برای درج کد در متن می‌توانید از مثال زیر استفاده کنید و به‌جای sh java javascript ... زبان کد را بنویسید.
...
تصاویر را نیز می‌توانید در شاخه‌ی public/images قرار دهید و با کدی شبیه به کد زیر از آن‌ها استفاده کنید.

```sh
![IMAGE_TITLE](/images/IMAGE_FILENAME)
```
...
برای اطلاعات بیشتر در مورد فرمت Markdown به [راهنمای گیت هاب](https://guides.github.com/features/mastering-markdown/) مراجعه کنید و
